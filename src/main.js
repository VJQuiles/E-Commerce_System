...
var discountCalculator_1 = require("./util/discountCalculator");
var taxCalculator_1 = require("./util/taxCalculator");
function doTheThings() {
    return __awaiter(this, void 0, void 0, function () {
        var productData, productList;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, apiService_1.fetchProductData)()];
                case 1:
                    productData = _a.sent();
                    productList = productData.map(function (products) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, doTheThings()];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    if (error_1 instanceof errorHandler_1.NetworkError) {
                        // throw error
                        console.error("Network Error:", error_1.message);
                    }
                    else if (error_1 instanceof errorHandler_1.DataError) {
                        // throw error
                        console.error("Network Error:", error_1.message);
                    }
                    else {
                        //throw new Error("Well I uh, I didn't see this coming.")
                        console.error("Well I uh, I didn't see this coming.", error_1);
                    }
                    return [3 /*break*/, 3];
