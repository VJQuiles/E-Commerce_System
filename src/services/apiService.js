        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    if (!response.ok) {
                        throw new errorHandler_1.NetworkError("Error connecting to network.");
                    }
                    return [4 /*yield*/, response.json()];
                case 2:
                    productData = _a.sent();
                    if (typeof productData !== "object" || productData === null) {
                        throw new errorHandler_1.DataError("Error parsing data. It's in French. I took latin in high school. I wanted to talk like Yoda.");
                    }
